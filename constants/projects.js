...
const projects = [
  {
    ...
    description:
      "Designed & Built from scratch with a modern design, DesoDomains.xyz is the most advanced auction platform on the deso blockchain that allows exchanging of domains names through instant transfers or auction of extensible duration.",
    stack: [
      {
        name: "Next Js",
        icon: nextJs,
  ...
  },
  {
    ...
    description:
      "A cross platform mobile app that serves as one place to access details & rating of local businesses and for " +
